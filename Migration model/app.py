...
bird_aliases = {
    "blue tailed bird": "Blue-tailed Bee-eater", "blue bird": "Blue-tailed Bee-eater",
    "bee eater": "Blue-tailed Bee-eater", "red bird": "Red-vented Bulbul",
    "bulbul": "Red-vented Bulbul", "white bird": "White-throated Kingfisher",
...
def predict_bird_presence(features):
    ...
    try:
        ...
        return {
            ...
            "meaningful_sentence": (
                f"The {features['bird_name']} is likely to be present at {features['locality']} on {features['day_of_week']}, "
                f"{features['month']}/{features['year']} at {features['hour']}:00. (Confidence: {probability:.1f}%)"
            )
        }
